...
def _add_residuals_cell() -> None:
    md(
        """## Residuos por muestra — spatial_transformer_residuals_h{H}.csv (significancia)
...
""",
        cell_id="cell-13-residuals-md",
    )
    code(
        """
TRANSFORMER_RESID_OUT = OUTPUT_DIR / f"spatial_transformer_residuals_h{HORIZON}.csv"
