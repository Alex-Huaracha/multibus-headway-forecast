...
>
> **Y no somos los primeros a los que les pasa.** Yu et al. (2016) enfrentan exactamente lo mismo en Pekín —*"most route schedules change over time depending on varying passenger demands"*— y lo resuelven del mismo modo: *"this study uses the headway at the first stop as the 'scheduled' headway"*. O sea, sustituyen el horario ausente por **una referencia observada del propio dato**. Nuestra media del vector es esa misma sustitución con otro punto de referencia. La práctica está establecida en el trabajo más citado del subcampo; lo que elegimos distinto es dónde poner la referencia.
>
