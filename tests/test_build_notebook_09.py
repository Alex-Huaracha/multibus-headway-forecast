"""Tests for src/build_notebook_09.py — W3-C1 RED.

Covers:
  AC-NB09-1: python -m src.build_notebook_09 exits 0 and produces both per-corridor
             notebooks (09a E2 and 09b E59).
...
# Both per-corridor notebook paths produced by build_notebook_09.py.
NOTEBOOK_09A_PATH = (
    ROOT / "notebooks" / "09_spatial_transformer" / "09a_e2" / "notebook.ipynb"
)
NOTEBOOK_09B_PATH = (
    ROOT / "notebooks" / "09_spatial_transformer" / "09b_e59" / "notebook.ipynb"
)
BOTH_PATHS = [NOTEBOOK_09A_PATH, NOTEBOOK_09B_PATH]
...
class TestNotebook09Builder:
    ...
    @pytest.mark.parametrize("nb_path", BOTH_PATHS, ids=["09a-E2", "09b-E59"])
